...
// 	// إرسال استجابة
// 	fmt.Fprintf(w, "Data receivet successfuly %s", data)
// }

//	func main() {
//		http.HandleFunc("/", handler)
//		fmt.Println("Serevr Run in port 8080")
//		http.ListenAndServe("172.31.247.123:8080", nil)
//	}
package main
...
var my_ip string = "192.168.45.149"
var my_port string = "8080"
// var slave1_ip="192.168.45.158"
var slave2_ip="192.168.45.139"
...
func main() {
	...
	// http.ListenAndServe("192.168.45.149:8080", nil)
}
...
func gloabelhande(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "فشل في إرسال البيانات إلى العبد", http.StatusInternalServerError)
		return
	}
...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	case "orders":
		...
		// طباعة البيانات
		fmt.Println("البيانات المستقبلة:", orderdata)
