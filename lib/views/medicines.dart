...
class _MedicinesState extends State<Medicines> {
  ...
  Future<void> MedicinesToServer() async {
    var url = Uri.parse(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: ListView(
          children: <Widget>[
            FeildText(field1Controller: field1Controller, text: "Medicine ID"),
            FeildText(field1Controller: field2Controller, text: "Name"),
            FeildText(field1Controller: field3Controller, text: "Description"),
            FeildText(field1Controller: field4Controller, text: "Price"),
            FeildText(
                field1Controller: field5Controller, text: "Quantity Available"),
            FeildText(
