...
class _CustomersState extends State<Customers> {
  ...
  Future<void> CustomersToServer() async {
    var url =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Customers Table'),
      ),
      body: Center(
        child: ListView(
          children: <Widget>[
            FeildText(field1Controller: field1Controller, text: "ID"),
            FeildText(field1Controller: field2Controller, text: "Name"),
            FeildText(field1Controller: field3Controller, text: "Email"),
            FeildText(field1Controller: field4Controller, text: "Address"),
            FeildText(field1Controller: field5Controller, text: "Phone"),
            FeildText(
